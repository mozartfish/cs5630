...
class Table {
    ...
    updateTable() {
        ...
        console.log("Appending td elements for the remaining columns");
        let tableData = tableRows.selectAll('td')
                                 .data(function(d){
                                     ...
                                     let entries = d3.entries(d);
                                    //  console.log("these are entries");
                                    //  console.log(entries);
                                    
                            
                                     // a list containing objects with values
                                     let elementList = d3.entries(d.value);
